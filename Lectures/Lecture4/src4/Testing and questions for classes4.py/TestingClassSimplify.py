...
class Flight:
    ...
    def print_info(self):
        ...
        #Answer, it worked. just need to make sure we create an object under the class, Flight, which cues the creation of a list, named self.passengers. To call it, we need the ObjectName.passengers)
